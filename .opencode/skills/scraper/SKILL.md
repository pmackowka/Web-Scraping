...
```
cd /Users/p/Documents/dev/Web-Scraping && source venv/bin/activate && python scrape.py -q "OpenCode" "Claude Code" -m 10 -t Top -l 200
```

Jeśli użytkownik podał własną frazę (np. "AI" "machine learning"):
```
cd /Users/p/Documents/dev/Web-Scraping && source venv/bin/activate && python scrape.py -q "AI" "machine learning" -m 10 -t Top -l 200
```
